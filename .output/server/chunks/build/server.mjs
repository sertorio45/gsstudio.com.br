import { defineComponent, ref, h, resolveComponent, hasInjectionContext, inject, unref, reactive, computed, watch, nextTick, onMounted, onBeforeUnmount, createVNode, Teleport, Transition, getCurrentInstance, watchEffect, isVNode, withModifiers, Fragment, version, defineAsyncComponent, provide, shallowReactive, Suspense, createApp, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, toValue, withCtx, createTextVNode, useSSRContext } from 'vue';
import { F as parseQuery, c as createError$1, G as defu, I as withQuery, J as joinURL, K as hasProtocol, L as isScriptProtocol, M as getContext, w as withTrailingSlash, N as withoutTrailingSlash, O as sanitizeStatusCode, $ as $fetch$1, P as baseURL, Q as createHooks, R as toRouteMatcher, S as createRouter$1, A as parseURL, T as withoutBase, k as destr, U as klona, V as camelCase, W as parse$1, X as getRequestHeader, Y as isEqual, Z as withLeadingSlash, _ as withBase, a0 as setCookie, a1 as getCookie, a2 as deleteCookie } from '../nitro/nitro.mjs';
