...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "83412fd5-5b92-4138-b283-c3cfeba69c5b",
    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2024-11-25T01:11:36.877Z"
        },
        "swr": 600,
        "cache": {
          "swr": true,
...
const _lazy_GOTSqJ = () => import('./articles/_slug_.mjs');
const _lazy_jxahxp = () => import('./parceiros.mjs');
const _lazy_yJaNKa = () => Promise.resolve().then(function () { return portifolio; });
const _lazy_Rekyk2 = () => import('../__og-image__/font/font.mjs');
const _lazy_MkoBeT = () => import('../__og-image__/image/image.mjs');
const _lazy_rzruMJ = () => import('../../_/renderer.mjs').then(function (n) { return n.r; });
