...
import { _ as _export_sfc, u as useHead, e as useRoute, f as useRouter, g as useRuntimeConfig, c as createError, b as useNuxtApp, d as asyncDataDefaults } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="my-5" id="article-detail" data-v-590ea0fb><div class="container my-5" data-v-590ea0fb><div class="row" data-v-590ea0fb><div class="col-lg-2 col-sm-12 col-md-12 mb-4" data-v-590ea0fb><div class="back-fixed" data-v-590ea0fb><button class="btn btn-primary-border" data-v-590ea0fb>Voltar</button><div class="social-share d-flex" data-v-590ea0fb><!--[-->`);
      ssrRenderList(socialNetworks.value, (network, index) => {
        _push(`<a${ssrRenderAttr("href", network.url)} target="_blank" class="social-icon"${ssrRenderAttr("title", network.name)} data-v-590ea0fb><i class="${ssrRenderClass(network.icon)}" data-v-590ea0fb></i></a>`);
      });
      _push(`<!--]--></div></div></div><div class="col-sm-7 col-md-12 col-lg-9" data-v-590ea0fb>`);
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-590ea0fb><div class="d-flex mb-3" data-v-590ea0fb><div class="skeleton skeleton-category me-2" data-v-590ea0fb></div><div class="skeleton skeleton-date" data-v-590ea0fb></div></div><div class="skeleton skeleton-title mb-3" data-v-590ea0fb></div><div class="skeleton skeleton-content mb-3" data-v-590ea0fb></div></div>`);
      } else if (unref(error)) {
        _push(`<div class="error-state" data-v-590ea0fb><div class="alert alert-danger" data-v-590ea0fb><h4 data-v-590ea0fb>Erro ao carregar o artigo</h4><p data-v-590ea0fb>${ssrInterpolate(unref(error))}</p><button class="btn btn-primary" data-v-590ea0fb>Voltar</button></div></div>`);
      } else if (unref(article)) {
        _push(`<div class="content_blog" data-v-590ea0fb><div class="mb-3 mx-0" data-v-590ea0fb><span class="article-category" data-v-590ea0fb>${ssrInterpolate(categoryTitle.value)}</span><span class="mx-3 publish_date" data-v-590ea0fb>${(_a = formatDate(unref(article).created_at)) != null ? _a : ""}</span></div><h1 data-v-590ea0fb>${ssrInterpolate(unref(article).title)}</h1><div class="my-4" data-v-590ea0fb>${(_b = unref(article).content) != null ? _b : ""}</div></div>`);
      } else {
        _push(`<div class="not-found-state" data-v-590ea0fb><div class="alert alert-warning" data-v-590ea0fb><h4 data-v-590ea0fb>Artigo n\xE3o encontrado</h4><p data-v-590ea0fb>O artigo que voc\xEA est\xE1 procurando n\xE3o existe ou foi removido.</p><button class="btn btn-primary" data-v-590ea0fb>Voltar</button></div></div>`);
      }
      _push(`</div></div></div></section><section data-v-590ea0fb><div class="container" data-v-590ea0fb><div class="row" data-v-590ea0fb><div class="col-md-6 col-sm-12 align-content-center mb-5 sm-mb-5" data-v-590ea0fb><h1 data-v-590ea0fb>Fale agora conosco</h1><p data-v-590ea0fb>Entre em contato conosco para tirar suas d\xFAvidas ou solicitar um or\xE7amento.</p></div><div class="col-md-6 col-sm-12" data-v-590ea0fb>`);
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-590ea0fb"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-BUdZXUfc.mjs.map
