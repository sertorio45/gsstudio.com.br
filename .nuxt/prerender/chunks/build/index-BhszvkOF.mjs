import { useSSRContext, defineComponent, ref, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, computed, mergeProps, withAsyncContext, createTextVNode } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderStyle } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc, N, d as useRoute, u as useHead, b as useSeoMeta, a as __nuxt_component_0$1$1 } from './server.mjs';
import { _ as _sfc_main$7 } from './NuxtImg-DPLwBVM5.mjs';
...
import { a as useFetch } from './fetch-BMZuAQ6g.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: articlesData, pending, error, refresh } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/articles", {
      method: "GET",
      headers: {
    ...
    }, "$jIvXbp5PRI")), __temp = await __temp, __restore(), __temp);
    const articles = computed(() => {
      var _a;
      return ((_a = articlesData.value) == null ? void 0 : _a.data) || [];
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
...
//# sourceMappingURL=index-BhszvkOF.mjs.map
