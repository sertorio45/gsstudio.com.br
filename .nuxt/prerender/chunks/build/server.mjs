import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, unref, computed, toValue, ref, defineComponent, watch, nextTick, onMounted, onBeforeUnmount, createVNode, Teleport, Transition, isVNode, withModifiers, Fragment, h, resolveComponent, mergeProps, withCtx, createTextVNode, useSSRContext, defineAsyncComponent, Suspense, provide, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/index.mjs';
import { createHooks } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/unctx/dist/index.mjs';
...
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, useRoute as useRoute$1, RouterView } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue-router/dist/vue-router.node.mjs';
...
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseURL, withLeadingSlash, withoutTrailingSlash, withBase, withTrailingSlash, withoutBase, parseQuery } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/ufo/dist/index.mjs';
import { stringify, parse } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/devalue/index.js';
import { u as useHead$1, h as headSymbol, a as useSeoMeta$1, b as useServerHead$1, r as resolveUnrefHeadInput } from '../_/renderer3.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  ...
  },
  {
    name: "sobre",
    path: "/sobre",
    component: () => import('./sobre.vue.mjs')
  },
  {
    name: "slug",
    path: "/:slug()",
  ...
  },
  {
    name: "contato",
    path: "/contato",
    component: () => import('./contato.vue.mjs')
  },
  {
    name: "servicos",
    path: "/servicos",
    component: () => import('./servicos.vue.mjs')
  },
  {
    name: "solucoes.bkop-gscrm",
    path: "/solucoes.bkop/gscrm",
    component: () => import('./gscrm.vue.mjs')
  },
  {
    name: "politica-de-privacidade",
    path: "/politica-de-privacidade",
    component: () => import('./politica-de-privacidade.vue.mjs')
  }
];
...
function getOgImagePath(pagePath, _options) {
  ...
  const path = joinURL("/", baseURL, `__og-image__/${"static" }`, pagePath, `og.${options.extension}`);
...
const nuxt_plugin_UFMCqFAmT_rT4NcMBSUgq5IuOGNlCK5IH_2sTbP0mGc = defineNuxtPlugin(async (nuxtApp) => {
  var _a, _b, _c;
...
const plugin_rUDZiDyu2mz5GP9COOWWhZy5JxTjYdMqtxbGqnYBOkg = defineNuxtPlugin((_nuxtApp) => {
  var _a;
...
const plugin_6ZhjavnMxFfYFG7tsyjoKHpgVIiZCdAzIuNWHwsY8yk = defineNuxtPlugin((_nuxtApp) => {
...
const plugins = [
  ...
  imask_omfLFb3SPcR2lajdB9Tw5bFAAg1lHLYLLsALKsDs_w4,
...
export { N, _export_sfc as _, __nuxt_component_0$1 as a, useRoute as b, useRequestFetch as c, useSeoMeta as d, useNuxtApp as e, fetchDefaults as f, asyncDataDefaults as g, createError as h, injectHead as i, useRouter as j, useRuntimeConfig as k, useOgImageRuntimeConfig as l, createOgImageMeta as m, normaliseOptions as n, getOgImagePath as o, useRequestEvent as p, useSiteConfig as q, server as r, separateProps as s, useHead as u };
