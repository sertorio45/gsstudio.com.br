...
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio2/node_modules/h3/dist/index.mjs';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug()",
    component: () => import('./_slug_-DwPKBFhG.mjs')
  },
  {
    name: "artigos-slug",
    path: "/artigos/:slug()",
    component: () => import('./_slug_-Vv-H-D36.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./blog-CblLvmzL.mjs')
  },
  {
    name: "contato",
    path: "/contato",
    component: () => import('./contato-ZOdZi58S.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dsr9W21P.mjs')
  },
  {
    name: "politica-de-privacidade",
    path: "/politica-de-privacidade",
    component: () => import('./politica-de-privacidade-CrankItW.mjs')
  },
  {
    name: "servicos",
    path: "/servicos",
    component: () => import('./servicos-DCgwfNLw.mjs')
  },
  {
    name: "sobre",
    path: "/sobre",
    component: () => import('./sobre-CVVyRex4.mjs')
  },
  {
    name: "solucoes",
    path: "/solucoes",
    component: () => import('./solucoes-THKpgUJY.mjs')
  }
];
...
const layouts = {
  default: () => import('./default-DPl_hSsV.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DYXxv6_i.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D4oD-0Pi.mjs'));
...
export { N, _export_sfc as _, useRouter as a, navigateTo as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, useRequestEvent as e, useSeoMeta as f, nuxtLinkDefaults as n, resolveRouteObject as r, useHead as u };
