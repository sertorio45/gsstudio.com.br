...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-w-_08CAa.mjs').then((m2) => m2.default || m2)
  }
];
...
const layouts = {
  default: () => import('./default-DFbYb3BD.mjs').then((m2) => m2.default || m2)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CTpAICCl.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BOW-ScfO.mjs').then((r) => r.default || r));
...
export { N, _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, useRouter as c, resolveRouteObject as d, entry$1 as default, navigateTo as e, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRequestEvent as u };
