import { withCtx, createTextVNode, defineComponent, withAsyncContext, mergeProps, unref, toDisplayString, ref, createVNode, createBlock, openBlock, Fragment, renderList, computed, useSSRContext } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderStyle } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc, u as useHead, d as useSeoMeta, a as __nuxt_component_0$1$1, N } from './server.mjs';
import { _ as _sfc_main$7 } from './NuxtImg-Be9QiiK0.mjs';
...
import { Autoplay } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/swiper/modules/index.mjs';
import { u as useAsyncData } from './asyncData-BYrznCe9.mjs';
import { d as defineOgImage } from './defineOgImage-CqgGswDu.mjs';
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "hero-animated d-flex align-items-center justify-content-center flex-column text-center" }, _attrs))} data-v-341c1adb><svg width="0" height="0" data-v-341c1adb><filter id="liquid" data-v-341c1adb><feTurbulence id="turb" type="turbulence" baseFrequency="0.02 0.03" numOctaves="2" result="turb" seed="2" data-v-341c1adb></feTurbulence><feDisplacementMap in2="turb" in="SourceGraphic" scale="0" xChannelSelector="R" yChannelSelector="G" id="disp" data-v-341c1adb></feDisplacementMap></filter></svg><h1 class="hero-title mb-3" data-v-341c1adb>Mentes criativas que criam</h1><div class="hero-animated-phrase-wrapper" data-v-341c1adb><h2 class="hero-animated-phrase" style="${ssrRenderStyle({ "filter": "url(#liquid)" })}" data-v-341c1adb><em data-v-341c1adb>${ssrInterpolate(phrases[currentPhrase.value])}</em></h2></div></section>`);
    };
  }
};
...
_sfc_main$6.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/HeroAnimated.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-341c1adb"]]);
const _sfc_main$5 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_HeroAnimated = __nuxt_component_0$1;
  const _component_NuxtLink = __nuxt_component_0$1$1;
  _push(`<div${ssrRenderAttrs(_attrs)}><section class="d-flex align-items-center mt-5 py-5 background-topo" id="index"><div class="container text-center py-5 my-5">`);
  _push(ssrRenderComponent(_component_HeroAnimated, null, null, _parent));
  _push(`<p class="my-4 lead">Design, tecnologia e marketing para neg\xF3cios que querem crescer com intelig\xEAncia.</p><div class="d-flex justify-content-center flex-column flex-md-row align-items-center px-2">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "#sobre",
    class: "my-2 ms-md-2 btn btn-primary"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Saiba mais sobre n\xF3s `);
      } else {
        return [
          createTextVNode(" Saiba mais sobre n\xF3s ")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/contato",
    class: "my-2 ms-md-2 btn btn-primary z-2"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Fale com nosso time `);
      } else {
        return [
          createTextVNode(" Fale com nosso time ")
        ];
      }
    }),
    _: 1
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Home/Topo.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: "text-center gscard my-5",
    id: "cta"
  }, _attrs))}><div class="container d-flex align-items-center justify-content-center bg-cta my-5"><div class="row"><div class="col text-light"><h2 class="text-light">Transforme o seu neg\xF3cio</h2><div class="subheadline d-flex justify-content-center py-2"><p>Potencialize seu neg\xF3cio com solu\xE7\xF5es criativas e inovadoras.</p></div>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/contato",
    class: "btn btn-white"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<em${_scopeId}>Entrar agora em contato</em>`);
      } else {
        return [
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Cta/Contact.vue");
          ...
          if (_push2) {
            ...
            ssrRenderList(parceiros2.value, (parceiro, index2) => {
              _push2(ssrRenderComponent(_component_SwiperSlide, { key: index2 }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", parceiro)} class="d-block w-100 parceiro-img"${ssrRenderAttr("alt", "Parceiro " + (index2 + 1))} loading="lazy" width="300px" height="300px" data-v-eeadcda5${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: parceiro,
...
const CarouselParceiros = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-eeadcda5"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: articles, pending: loading, error } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(
      "articles",
      async () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(error)) {
        _push(`<div class="col-12 my-3"><div class="alert alert-danger"> Erro ao carregar artigos: ${ssrInterpolate(unref(error).message || unref(error))}</div></div>`);
        ...
        ssrRenderList(unref(articles), (article) => {
          _push(`<div class="col-sm-3 my-2"><div class="card"><div class="card-body"><div class="mb-2"><span class="article-category">${ssrInterpolate(article.category_title)}</span></div>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/${article.slug}`,
            class: "article-link"
          }, {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_HomeTopo = __nuxt_component_0;
      const _component_NuxtLink = __nuxt_component_0$1$1;
      const _component_NuxtImg = _sfc_main$7;
      const _component_CtaContact = __nuxt_component_3;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_HomeTopo, null, null, _parent));
      _push(`<section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-ec75f201><div class="container" data-v-ec75f201><div class="row" data-v-ec75f201><div class="col-12 col-md-12 col-lg-6" data-v-ec75f201><h2 data-v-ec75f201>Somos especialistas</h2><p class="my-3" data-v-ec75f201> A GS Studio \xE9 uma ag\xEAncia que combina marketing, design e tecnologia para criar solu\xE7\xF5es criativas que impulsionam o sucesso de neg\xF3cios. Nosso foco est\xE1 em entregar resultados que realmente fazem a diferen\xE7a. </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/sobre",
      ...
      _push(`</div><div class="col-12 col-md-12 col-lg-6 text-center d-flex align-items-sm-center justify-content-sm-end py-lg-0 py-md-5" data-v-ec75f201><div class="row w-100" data-v-ec75f201><div class="col-12 col-sm-6 col-md-4 d-flex mb-3 mb-md-0" data-v-ec75f201><div class="gscard gscard-border w-100" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/icon-design.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Design para marketing e comunica\xE7\xE3o"
      }, null, _parent));
      _push(`<h3 data-v-ec75f201>Design</h3></div></div><div class="col-12 col-sm-6 col-md-4 d-flex mb-3 mb-md-0" data-v-ec75f201><div class="gscard gscard-border w-100" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/icon-marketing.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Marketing e comunica\xE7\xE3o digital"
      }, null, _parent));
      _push(`<h3 data-v-ec75f201>Marketing</h3></div></div><div class="col-12 col-sm-6 col-md-4 d-flex" data-v-ec75f201><div class="gscard gscard-border w-100" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "/icons/icon-tecnologia.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Tecnologia para sites e comunica\xE7\xE3o"
      }, null, _parent));
      _push(`<h3 data-v-ec75f201>Tecnologia</h3></div></div><div class="mt-5" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/sobre",
      ...
      _push(`</div></div></div></div></div></section><section class="text-center py-5 d-flex justify-content-center align-items-center" id="conquistas" data-v-ec75f201><div class="container" data-v-ec75f201><div class="row g-4" data-v-ec75f201><div class="col-12 col-sm-6 col-md-6 col-lg-3" data-v-ec75f201><div class="gscard gscard-border d-flex flex-column justify-content-center align-items-center" data-v-ec75f201><h3 class="mb-2" data-v-ec75f201><em data-v-ec75f201>+ de <em class="count" data-count="65" data-v-ec75f201>0</em></em></h3><span class="text-muted" data-v-ec75f201>Sites produzidos</span></div></div><div class="col-12 col-sm-6 col-md-6 col-lg-3" data-v-ec75f201><div class="gscard gscard-border d-flex flex-column justify-content-center align-items-center" data-v-ec75f201><h3 class="mb-2" data-v-ec75f201><em data-v-ec75f201>+ de <em class="count" data-count="400" data-v-ec75f201>0</em></em></h3><span class="text-muted" data-v-ec75f201>Clientes ativos</span></div></div><div class="col-12 col-sm-6 col-md-6 col-lg-3" data-v-ec75f201><div class="gscard gscard-border d-flex flex-column justify-content-center align-items-center p-4" data-v-ec75f201><h3 class="mb-2" data-v-ec75f201><em data-v-ec75f201>+ de <em class="count" data-count="80" data-v-ec75f201>0</em></em></h3><span class="text-muted" data-v-ec75f201>Marcas desenvolvidas</span></div></div><div class="col-12 col-sm-6 col-md-6 col-lg-3" data-v-ec75f201><div class="gscard gscard-border d-flex flex-column justify-content-center align-items-center" data-v-ec75f201><h3 class="mb-2" data-v-ec75f201><em data-v-ec75f201>+ de <em class="count" data-count="7" data-v-ec75f201>0</em></em></h3><span class="text-muted" data-v-ec75f201>Anos de mercado</span></div></div></div></div></section><section class="my-5 d-flex align-items-center justify-content-center" id="parceiros" data-v-ec75f201><div class="container text-center my-5" data-v-ec75f201><div class="row" data-v-ec75f201><h2 data-v-ec75f201>Parceiros e clientes</h2><div id="app" data-v-ec75f201><div class="col" data-v-ec75f201>`);
      _push(ssrRenderComponent(CarouselParceiros, null, null, _parent));
      _push(`</div></div></div></div></section><section class="d-flex align-items-center justify-content-center bg-light py-5" id="servicos" data-v-ec75f201><div class="container text-center my-5" data-v-ec75f201><div class="row" data-v-ec75f201><h2 data-v-ec75f201>Solu\xE7\xF5es e servi\xE7os</h2><p class="my-3" data-v-ec75f201> A GS STUDIO est\xE1 comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estrat\xE9gia eficaz, geram resultados melhores e duradouros. </p><div class="row p-3" data-v-ec75f201><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-ec75f201><div class="gscard gscard-border h-100" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/servicos/sites.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Cria\xE7\xE3o de sites e comunica\xE7\xE3o"
      }, null, _parent));
      _push(`<h3 data-v-ec75f201>Cria\xE7\xE3o de sites</h3></div></div><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-ec75f201><div class="gscard gscard-border h-100" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/servicos/gestao_de_conteudo.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Gest\xE3o de conte\xFAdo e redes sociais"
      }, null, _parent));
      _push(`<h3 data-v-ec75f201>Redes sociais</h3></div></div><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-ec75f201><div class="gscard gscard-border h-100" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/servicos/lojas_virtuais.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Lojas virtuais e marketing digital"
      }, null, _parent));
      _push(`<h3 class="h1" data-v-ec75f201>Lojas virtuais</h3></div></div><div class="col-6 col-sm-6 col-md-3" data-v-ec75f201><div class="gscard gscard-border" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/servicos/branding.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Cria\xE7\xE3o de marcas e branding"
      }, null, _parent));
      _push(`<h3 data-v-ec75f201>Produ\xE7\xE3o de marcas</h3></div></div></div><div class="row mt-5" data-v-ec75f201><div class="col" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/servicos",
        class: "btn btn-primary"
      }, {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ec75f201"]]);

export { index as default };
//# sourceMappingURL=index-9aFFs86i.mjs.map
