...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  var _a, _b;
  _push(`<main${ssrRenderAttrs(_attrs)} data-v-8654ff1e><section class="my-5" id="article-detail" data-v-8654ff1e><div class="container my-5" data-v-8654ff1e><div class="row" data-v-8654ff1e><div class="col-lg-2 col-sm-12 col-md-12 mb-4" data-v-8654ff1e><div class="back-fixed" data-v-8654ff1e><button class="btn btn-primary-border" data-v-8654ff1e>&lt; Voltar</button><div class="social-share d-flex" data-v-8654ff1e><!--[-->`);
  ssrRenderList(_ctx.socialNetworks, (network, index) => {
    _push(`<a${ssrRenderAttr("href", network.url)} target="_blank" class="social-icon"${ssrRenderAttr("title", network.name)} data-v-8654ff1e><i class="${ssrRenderClass(network.icon)}" data-v-8654ff1e></i></a>`);
  });
  _push(`<!--]--></div></div></div><div class="col-sm-7 col-md-12 col-lg-7" data-v-8654ff1e>`);
  if (_ctx.loading) {
    _push(`<div data-v-8654ff1e><div class="d-flex mb-3" data-v-8654ff1e><div class="skeleton skeleton-category me-2" data-v-8654ff1e></div><div class="skeleton skeleton-date" data-v-8654ff1e></div></div><div class="skeleton skeleton-title mb-3" data-v-8654ff1e></div><div class="skeleton skeleton-img mb-3" data-v-8654ff1e></div><div class="skeleton skeleton-content mb-3" data-v-8654ff1e></div></div>`);
  } else if (_ctx.article) {
    _push(`<div class="content_blog" data-v-8654ff1e><div class="mb-3 mx-0" data-v-8654ff1e><span class="article-category" data-v-8654ff1e>${ssrInterpolate(_ctx.article.category.title)}</span><span class="mx-3 publish_date" data-v-8654ff1e>${(_a = _ctx.formatDate(_ctx.article.published_at)) != null ? _a : ""}</span></div><h1 data-v-8654ff1e>${ssrInterpolate(_ctx.article.titulo)}</h1><div class="my-4" data-v-8654ff1e>`);
    if (_ctx.hasThumbnail(_ctx.article)) {
      _push(`<picture data-v-8654ff1e><source${ssrRenderAttr("srcset", _ctx.getArticleImage(_ctx.article))} data-v-8654ff1e><img${ssrRenderAttr("src", _ctx.getArticleImage(_ctx.article))} class="${ssrRenderClass([{ "blurred": !_ctx.imageLoaded }, "img-fluid blur-effect"])}"${ssrRenderAttr("alt", _ctx.article.titulo)} loading="lazy" data-v-8654ff1e></picture>`);
    } else {
      _push(`<img src="https://s3.gsstudio.com.br/gsstudio/site/img/thumb_blog_gsstudio.webp" class="${ssrRenderClass([{ "blurred": !_ctx.imageLoaded }, "img-fluid blur-effect"])}" alt="Default Image" loading="lazy" style="${ssrRenderStyle({ "width": "100%" })}" data-v-8654ff1e>`);
    }
    _push(`</div><div data-v-8654ff1e>${(_b = _ctx.article.content) != null ? _b : ""}</div></div>`);
  } else {
    _push(`<div data-v-8654ff1e><p data-v-8654ff1e>Artigo n\xE3o encontrado.</p></div>`);
  }
  _push(`</div><div class="col-sm-12 col-md-12 col-lg-3" data-v-8654ff1e><div class="newsletter-cta p-4 bg-light rounded news-fixed my-xl-0 my-4" data-v-8654ff1e><h3 data-v-8654ff1e>Assine para novas atualiza\xE7\xF5es.</h3><form class="form" data-v-8654ff1e><div class="mb-3" data-v-8654ff1e><input${ssrRenderAttr("value", _ctx.email)} type="email" class="form-control" id="email" name="email" placeholder="E-mail" required data-v-8654ff1e></div><div class="" data-v-8654ff1e><button type="submit" class="${ssrRenderClass(["btn", _ctx.isSubmitting ? "btn-secondary" : _ctx.success ? "btn-success" : _ctx.error ? "btn-danger" : "btn-primary"])}"${ssrIncludeBooleanAttr(_ctx.isSubmitting) ? " disabled" : ""} data-v-8654ff1e>`);
  if (_ctx.isSubmitting) {
    _push(`<span data-v-8654ff1e><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" data-v-8654ff1e></span> Enviando... </span>`);
  } else if (_ctx.success) {
    _push(`<span data-v-8654ff1e><i class="bx bx-check-circle" data-v-8654ff1e></i> Sucesso! </span>`);
  } else if (_ctx.error) {
    _push(`<span data-v-8654ff1e><i class="bx bx-error" data-v-8654ff1e></i> Erro ao enviar! </span>`);
  } else {
    _push(`<span data-v-8654ff1e><i class="bx bx-send" data-v-8654ff1e></i> Inscrever-se </span>`);
  }
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8654ff1e"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-ApJzuxqc.mjs.map
