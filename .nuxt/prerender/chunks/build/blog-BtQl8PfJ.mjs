import { u as useHead, h as useSeoMeta, a as __nuxt_component_0$1 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="row my-3"><div class="col d-flex align-content-center justify-content-center"><button${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} class="btn btn-primary">`);
      if (unref(loading)) {
...
//# sourceMappingURL=blog-BtQl8PfJ.mjs.map
