import { _ as _export_sfc, b as useNuxtApp, u as useHead, m as useSeoMeta, a as __nuxt_component_0$1 } from './server.mjs';
...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrGetDirectiveProps, ssrGetDynamicModelProps, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderComponent, ssrRenderClass, ssrRenderStyle } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      let _temp0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-e9739c7d><div class="gscard-border p-5" data-v-e9739c7d><form data-v-e9739c7d><div class="row" data-v-e9739c7d><div class="col-md-6 mb-4" data-v-e9739c7d><div class="input-group" data-v-e9739c7d><span class="input-group-text" data-v-e9739c7d><i class="bx bx-user" data-v-e9739c7d></i></span><input${ssrRenderAttr("value", form.value.name)} placeholder="Seu nome completo*" class="form-control input-text-size" required data-v-e9739c7d></div></div><div class="col-md-6 mb-4" data-v-e9739c7d><div class="input-group" data-v-e9739c7d><span class="input-group-text" data-v-e9739c7d><i class="bx bx-envelope" data-v-e9739c7d></i></span><input${ssrRenderAttr("value", form.value.email)} type="email" placeholder="Seu melhor e-mail*" class="form-control input-text-size" required data-v-e9739c7d></div></div></div><div class="row" data-v-e9739c7d><div class="col-md-6 mb-4" data-v-e9739c7d><div class="input-group" data-v-e9739c7d><span class="input-group-text" data-v-e9739c7d><i class="bx bx-globe" data-v-e9739c7d></i></span><select class="form-control input-text-size" required data-v-e9739c7d><option value="" disabled selected data-v-e9739c7d>Selecione o UF*</option><!--[-->`);
      ssrRenderList(estados.value, (estado) => {
        _push(`<option${ssrRenderAttr("value", estado.sigla)} data-v-e9739c7d>${ssrInterpolate(estado.nome)}</option>`);
      });
      _push(`<!--]--></select></div></div><div class="col-md-6 mb-4" data-v-e9739c7d><div class="input-group" data-v-e9739c7d><span class="input-group-text" data-v-e9739c7d><i class="bx bx-map" data-v-e9739c7d></i></span><select class="form-control input-text-size" required data-v-e9739c7d><option value="" disabled selected data-v-e9739c7d>Selecione a cidade*</option><!--[-->`);
      ssrRenderList(cidades.value, (cidade) => {
        _push(`<option${ssrRenderAttr("value", cidade.nome)} data-v-e9739c7d>${ssrInterpolate(cidade.nome)}</option>`);
      });
      _push(`<!--]--></select></div></div></div><div class="row" data-v-e9739c7d><div class="col-md-6 mb-4" data-v-e9739c7d><div class="input-group" data-v-e9739c7d><span class="input-group-text" data-v-e9739c7d><i class="bx bx-phone" data-v-e9739c7d></i></span><input${ssrRenderAttrs((_temp0 = mergeProps({
        value: form.value.phone,
        placeholder: "Celular*",
        class: "form-control input-text-size",
        required: ""
      }, ssrGetDirectiveProps(_ctx, _directive_mask, "(00) 00000-0000")), mergeProps(_temp0, ssrGetDynamicModelProps(_temp0, form.value.phone))))} data-v-e9739c7d></div></div><div class="col-md-6 mb-4" data-v-e9739c7d><div class="input-group" data-v-e9739c7d><span class="input-group-text" data-v-e9739c7d><i class="bx bx-building" data-v-e9739c7d></i></span><input${ssrRenderAttr("value", form.value.company)} placeholder="Nome da empresa*" class="form-control input-text-size" required data-v-e9739c7d></div></div></div><div class="form-group mb-4" data-v-e9739c7d><textarea placeholder="Nos conte um pouco sobre sua necessidade*" class="form-control textarea-height input-text-size" required data-v-e9739c7d>${ssrInterpolate(form.value.message)}</textarea></div><div class="form-group mb-4 form-check" data-v-e9739c7d><input type="checkbox" class="form-check-input"${ssrIncludeBooleanAttr(Array.isArray(form.value.terms) ? ssrLooseContain(form.value.terms, null) : form.value.terms) ? " checked" : ""} required data-v-e9739c7d><label class="form-check-label" data-v-e9739c7d> Ao enviar voc\xEA ser\xE1 protegido por Google reCAPTCHA e sujeito \xE0 `);
      ...
      _push(`</label></div><div class="form-group text-center" data-v-e9739c7d><button type="submit" class="${ssrRenderClass(["btn m-0", isSubmitting.value ? "btn-secondary" : success.value ? "btn-success" : "btn-primary"])}"${ssrIncludeBooleanAttr(isSubmitting.value) ? " disabled" : ""} data-v-e9739c7d>`);
      if (isSubmitting.value) {
        _push(`<span data-v-e9739c7d><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" data-v-e9739c7d></span> Enviando... </span>`);
      } else if (success.value) {
        _push(`<span data-v-e9739c7d><i class="bx bx-check-circle" data-v-e9739c7d></i> Sucesso! </span>`);
      } else {
        _push(`<span data-v-e9739c7d><i class="bx bx-send" data-v-e9739c7d></i> Enviar </span>`);
      }
...
const Form = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e9739c7d"]]);
const __default__ = {
  components: {
    Form
  },
...
//# sourceMappingURL=contato-BnX8RY3O.mjs.map
