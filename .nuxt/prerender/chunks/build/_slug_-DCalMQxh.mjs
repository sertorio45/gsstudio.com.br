import { defineComponent, useSSRContext, ref, computed, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, unref, shallowRef, toRef, getCurrentInstance, onServerPrefetch } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/index.mjs';
import { _ as _export_sfc, u as useHead, e as useRoute, f as useRouter, b as useNuxtApp, d as asyncDataDefaults, c as createError } from './server.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { data: article, pending: loading, error: fetchError } = useAsyncData(
      ...
      async () => {
        if (!slug.value)
          throw new Error("Slug n\xE3o fornecido");
        const response = await $fetch(`${baseURL}/articles?slug=${slug.value}`);
        if (response.length > 0) {
          return response[0];
        } else {
          throw new Error("Artigo n\xE3o encontrado");
        }
      }
    );
...
//# sourceMappingURL=_slug_-DCalMQxh.mjs.map
