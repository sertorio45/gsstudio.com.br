import { _ as _export_sfc, N, u as useHead, m as useSeoMeta, a as __nuxt_component_0$1 } from './server.mjs';
import { _ as _sfc_main$4 } from './NuxtImg-DwLlU7V9.mjs';
import { useSSRContext, defineComponent, ref, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, computed, mergeProps, createTextVNode, toDisplayString } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio_digital/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-e61856ab><div class="container" data-v-e61856ab><div class="row" data-v-e61856ab><div class="col-12 col-md-5" data-v-e61856ab><h2 data-v-e61856ab>Somos especialistas</h2><p class="my-3" data-v-e61856ab> A GS Studio \xE9 uma ag\xEAncia que combina marketing, design e tecnologia para criar solu\xE7\xF5es criativas que impulsionam o sucesso de neg\xF3cios. Nosso foco est\xE1 em entregar resultados que realmente fazem a diferen\xE7a. </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/sobre",
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center justify-content-center bg-light py-5" id="servicos" data-v-e61856ab><div class="container text-center my-5" data-v-e61856ab><div class="row" data-v-e61856ab><h2 data-v-e61856ab>Solu\xE7\xF5es e servi\xE7os</h2><p class="my-3" data-v-e61856ab> A GS STUDIO est\xE1 comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estrat\xE9gia eficaz, geram resultados melhores e duradouros. </p><div class="row p-3" data-v-e61856ab><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-e61856ab><div class="gscard gscard-border" data-v-e61856ab>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
...
//# sourceMappingURL=index-dfxTVMDQ.mjs.map
