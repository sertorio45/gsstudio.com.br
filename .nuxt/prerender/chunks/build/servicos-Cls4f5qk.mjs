import { _ as _export_sfc, u as useHead, m as useSeoMeta, a as __nuxt_component_0$1 } from './server.mjs';
import { _ as _sfc_main$1 } from './Icon-5pRBvot5.mjs';
import { _ as _sfc_main$2 } from './NuxtImg-DwLlU7V9.mjs';
...
import { d as defineOgImage } from './defineOgImage-DZtjH7qo.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><section class="bg-dark min-vh-100 d-flex justify-content-center align-items-center pt-5" id="topo" data-v-4ca6ae01><div class="container d-flex" data-v-4ca6ae01><div class="row" data-v-4ca6ae01><div class="col text-center text-light my-2" data-v-4ca6ae01><div class="my-2" data-v-4ca6ae01>`);
      ...
      _push(` / <span data-v-4ca6ae01>Servi\xE7os</span></div><h1 class="text-light" data-v-4ca6ae01>Transformando <em data-v-4ca6ae01>ideias</em> em <em data-v-4ca6ae01>resultados</em> exponenciais.</h1><p class="my-4" data-v-4ca6ae01>Descubra nossos servi\xE7os em Design, Marketing e Tecnologia para impulsionar o crescimento do seu neg\xF3cio.</p><a href="#tecnologia" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_Icon, {
        icon: "bx bxs-chevrons-down my-3",
        fontSize: "3em",
        color: "#fff"
      }, null, _parent));
      _push(`</a></div></div></div></section><section id="tecnologia" class="my-5 py-5 min-vh-100 d-flex" data-v-4ca6ae01><div class="container justify-content-center align-content-center" data-v-4ca6ae01><div class="row mb-4" data-v-4ca6ae01><div class="col text-center" data-v-4ca6ae01><h2 data-v-4ca6ae01>Tecnologia</h2><p data-v-4ca6ae01>Desenvolvimento de Sites, Lojas Virtuais, Solu\xE7\xF5es Personalizadas</p></div></div><div class="row text-center gy-4" data-v-4ca6ae01><div class="col-12 col-sm-6 col-md-4" data-v-4ca6ae01><div class="gscard gscard-border" data-v-4ca6ae01>`);
      ...
      _push(`<h3 data-v-4ca6ae01>Desenvolvimento de Sites</h3><p data-v-4ca6ae01>Constru\xEDmos sites personalizados que n\xE3o apenas parecem incr\xEDveis, mas tamb\xE9m funcionam perfeitamente.</p></div></div><div class="col-12 col-sm-6 col-md-4" data-v-4ca6ae01><div class="gscard gscard-border" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`<h3 data-v-4ca6ae01>Lojas Virtuais</h3><p data-v-4ca6ae01>Criamos e-commerce robustos e escal\xE1veis que proporcionam uma experi\xEAncia de compra fluida para seus clientes.</p></div></div><div class="col-12 col-sm-6 col-md-4" data-v-4ca6ae01><div class="gscard gscard-border" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`<h3 data-v-4ca6ae01>Solu\xE7\xF5es Personalizadas</h3><p data-v-4ca6ae01>Desenvolvemos solu\xE7\xF5es tecnol\xF3gicas sob medida para atender \xE0s necessidades espec\xEDficas do seu neg\xF3cio.</p></div></div><div class="my-5" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contato",
      ...
      _push(`</div></div></div></section><section id="marketing" class="py-5 bg-light min-vh-100 d-flex" data-v-4ca6ae01><div class="container my-5 justify-content-center align-content-center text-center" data-v-4ca6ae01><div class="row mb-4" data-v-4ca6ae01><div class="col text-center" data-v-4ca6ae01><h2 data-v-4ca6ae01>Marketing</h2><p data-v-4ca6ae01>Gest\xE3o de Redes Sociais, Tr\xE1fego Pago, Otimiza\xE7\xE3o SEO, Audiovisual</p></div></div><div class="row text-center gy-4" data-v-4ca6ae01><div class="col-12 col-sm-6 col-md-4" data-v-4ca6ae01><div class="gscard gscard-border" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`<h3 data-v-4ca6ae01>Gest\xE3o de Redes Sociais</h3><p data-v-4ca6ae01>Desenvolvemos estrat\xE9gias personalizadas para aumentar a sua presen\xE7a nas redes sociais.</p></div></div><div class="col-12 col-sm-6 col-md-4" data-v-4ca6ae01><div class="gscard gscard-border" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`<h3 data-v-4ca6ae01>Tr\xE1fego Pago</h3><p data-v-4ca6ae01>Maximize o retorno sobre o investimento com campanhas de publicidade pagas eficientes.</p></div></div><div class="col-12 col-sm-6 col-md-4" data-v-4ca6ae01><div class="gscard gscard-border" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`<h3 data-v-4ca6ae01>Otimiza\xE7\xE3o SEO</h3><p data-v-4ca6ae01>Melhore a visibilidade do seu site nos motores de busca com nossas t\xE9cnicas avan\xE7adas de SEO.</p></div></div></div><div class="my-5" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contato",
        class: "btn btn-primary"
      }, {
      ...
      _push(`</div></div></section><section id="design" class="py-5 min-vh-100 d-flex" data-v-4ca6ae01><div class="container my-5 justify-content-center align-content-center" data-v-4ca6ae01><div class="row mb-4" data-v-4ca6ae01><div class="col text-center" data-v-4ca6ae01><h2 data-v-4ca6ae01>Design</h2><p data-v-4ca6ae01>Cria\xE7\xE3o de Marcas, Comunica\xE7\xE3o Visual, Web Design</p></div></div><div class="row text-center gy-4" data-v-4ca6ae01><div class="col-12 col-sm-6 col-md-4" data-v-4ca6ae01><div class="gscard gscard-border" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "/icons/servicos/branding.svg",
        class: "p-2 my-1",
        width: "100px",
      ...
      _push(`<h3 data-v-4ca6ae01>Cria\xE7\xE3o de Marcas</h3><p data-v-4ca6ae01>Desenvolvemos identidades visuais que capturam a ess\xEAncia da sua empresa e se conectam com seu p\xFAblico-alvo.</p></div></div><div class="col-12 col-sm-6 col-md-4" data-v-4ca6ae01><div class="gscard gscard-border" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`<h3 data-v-4ca6ae01>Comunica\xE7\xE3o Visual</h3><p data-v-4ca6ae01>Projetamos materiais visuais impactantes que refor\xE7am a sua mensagem e destacam a sua marca.</p></div></div><div class="col-12 col-sm-6 col-md-4" data-v-4ca6ae01><div class="gscard gscard-border" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`<h3 data-v-4ca6ae01>Audiovisual</h3><p data-v-4ca6ae01>Produzimos v\xEDdeos e outros conte\xFAdos audiovisuais que capturam a aten\xE7\xE3o e transmitem sua mensagem de forma envolvente.</p></div></div><div class="my-5" data-v-4ca6ae01>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contato",
        class: "btn btn-primary"
      }, {
      ...
      _push(`</div></div></div></section><section class="text-center gscard" id="cta" data-v-4ca6ae01><div class="container d-flex align-items-center justify-content-center bg-cta" data-v-4ca6ae01><div class="row" data-v-4ca6ae01><div class="col text-light" data-v-4ca6ae01><h2 class="text-light" data-v-4ca6ae01>Transforme Resultados com Design, Marketing e Tecnologia!</h2><div class="subheadline d-flex justify-content-center py-2" data-v-4ca6ae01><p data-v-4ca6ae01>Potencialize seu neg\xF3cio com solu\xE7\xF5es criativas e inovadoras. N\xF3s entregamos resultados excepcionais atrav\xE9s de estrat\xE9gias personalizadas e tecnologia de ponta.</p></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contato",
        class: "btn btn-white"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<em data-v-4ca6ae01${_scopeId}>Entrar agora em contato</em>`);
          } else {
            return [
...
const servicos = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4ca6ae01"]]);

export { servicos as default };
//# sourceMappingURL=servicos-Cls4f5qk.mjs.map
