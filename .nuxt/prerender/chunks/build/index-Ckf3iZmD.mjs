...
import { _ as _sfc_main$7 } from './NuxtImg-_-Jep-ms.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: articlesData, pending, error, refresh } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(
      "articles",
      async () => {
...
//# sourceMappingURL=index-Ckf3iZmD.mjs.map
