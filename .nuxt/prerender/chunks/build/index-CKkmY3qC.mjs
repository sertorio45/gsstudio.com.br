...
import { _ as _sfc_main$4 } from './NuxtImg-BKTSrjOk.mjs';
import { useSSRContext, defineComponent, ref, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, computed, mergeProps, createTextVNode, toDisplayString } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderList, ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio/node_modules/vue/server-renderer/index.mjs';
import { S as Swiper2, a as SwiperSlide } from './entry-styles-1.mjs-BOr9JiZg.mjs';
import { Autoplay } from 'file:///Users/giovannisertorio/Desktop/Sites/gsstudio/node_modules/swiper/modules/index.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$1;
      const _component_NuxtImg = _sfc_main$4;
      _push(`<!--[--><section class="d-flex align-items-center min-vh-100" id="index" data-v-a1256ca7><div class="container text-center" data-v-a1256ca7><div class="row" data-v-a1256ca7><div class="col" data-v-a1256ca7><h1 data-v-a1256ca7><em data-v-a1256ca7>Posicionamento, resultados e performance para sua empresa.</em></h1><p class="my-4" data-v-a1256ca7>Fazemos sua empresa crescer usando branding, tecnologia e marketing.</p><div class="d-flex justify-content-center flex-column flex-md-row align-items-center px-2" data-v-a1256ca7><button class="btn btn-primary my-2" data-v-a1256ca7>Nos conhe\xE7a um pouco</button>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contato",
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-a1256ca7><div class="container" data-v-a1256ca7><div class="row" data-v-a1256ca7><div class="col-12 col-md-5" data-v-a1256ca7><h2 data-v-a1256ca7>Somos especialistas</h2><p class="my-3" data-v-a1256ca7> A GS Studio \xE9 uma ag\xEAncia que combina marketing, design e tecnologia para criar solu\xE7\xF5es criativas que impulsionam o sucesso de neg\xF3cios. Nosso foco est\xE1 em entregar resultados que realmente fazem a diferen\xE7a. </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/sobre",
        class: "btn btn-primary"
      }, {
      ...
      _push(`</div><div class="col-12 col-md-7 text-center d-flex align-items-center justify-content-end" data-v-a1256ca7><div class="row w-100" data-v-a1256ca7><div class="col-12 col-sm-6 col-md-4 d-flex mb-3 mb-md-0" data-v-a1256ca7><div class="gscard gscard-border w-100" data-v-a1256ca7>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/icon-design.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Design para marketing e comunica\xE7\xE3o"
      }, null, _parent));
      _push(`<h3 data-v-a1256ca7>Design</h3></div></div><div class="col-12 col-sm-6 col-md-4 d-flex mb-3 mb-md-0" data-v-a1256ca7><div class="gscard gscard-border w-100" data-v-a1256ca7>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/icon-marketing.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Marketing e comunica\xE7\xE3o digital"
      }, null, _parent));
      _push(`<h3 data-v-a1256ca7>Marketing</h3></div></div><div class="col-12 col-sm-6 col-md-4 d-flex" data-v-a1256ca7><div class="gscard gscard-border w-100" data-v-a1256ca7>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "/icons/icon-tecnologia.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Tecnologia para sites e comunica\xE7\xE3o"
      }, null, _parent));
      _push(`<h3 data-v-a1256ca7>Tecnologia</h3></div></div></div></div></div></div></section><section class="text-center my-5 py-5 d-flex justify-content-center align-items-center" id="conquistas" data-v-a1256ca7><div class="container" data-v-a1256ca7><div class="row" data-v-a1256ca7><div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-a1256ca7><div class="gscard gscard-border" data-v-a1256ca7><h3 data-v-a1256ca7><em data-v-a1256ca7>+ de <em class="count" data-count="65" data-v-a1256ca7>0</em></em></h3><span data-v-a1256ca7>Sites produzidos</span></div></div><div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-a1256ca7><div class="gscard gscard-border" data-v-a1256ca7><h3 data-v-a1256ca7><em data-v-a1256ca7>+ de <em class="count" data-count="400" data-v-a1256ca7>0</em></em></h3><span data-v-a1256ca7>Clientes ativos</span></div></div><div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-a1256ca7><div class="gscard gscard-border" data-v-a1256ca7><h3 data-v-a1256ca7><em data-v-a1256ca7>+ de <em class="count" data-count="80" data-v-a1256ca7>0</em></em></h3><span data-v-a1256ca7>Marcas desenvolvidas</span></div></div><div class="col-12 col-sm-6 col-md-3" data-v-a1256ca7><div class="gscard gscard-border" data-v-a1256ca7><h3 data-v-a1256ca7><em data-v-a1256ca7>+ de <em class="count" data-count="7" data-v-a1256ca7>0</em></em></h3><span data-v-a1256ca7>Anos de mercado</span></div></div></div></div></section><section class="my-5 d-flex align-items-center justify-content-center" id="parceiros" data-v-a1256ca7><div class="container text-center my-5" data-v-a1256ca7><div class="row" data-v-a1256ca7><h2 data-v-a1256ca7>Parceiros e clientes</h2><div id="app" data-v-a1256ca7><div class="col" data-v-a1256ca7>`);
      _push(ssrRenderComponent(CarouselParceiros, null, null, _parent));
      _push(`</div></div></div></div></section><section class="d-flex align-items-center justify-content-center bg-light py-5" id="servicos" data-v-a1256ca7><div class="container text-center my-5" data-v-a1256ca7><div class="row" data-v-a1256ca7><h2 data-v-a1256ca7>Solu\xE7\xF5es e servi\xE7os</h2><p class="my-3" data-v-a1256ca7> A GS STUDIO est\xE1 comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estrat\xE9gia eficaz, geram resultados melhores e duradouros. </p><div class="row p-3" data-v-a1256ca7><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-a1256ca7><div class="gscard gscard-border" data-v-a1256ca7>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/servicos/sites.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Cria\xE7\xE3o de sites e comunica\xE7\xE3o"
      }, null, _parent));
      _push(`<h3 data-v-a1256ca7>Sites</h3></div></div><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-a1256ca7><div class="gscard gscard-border" data-v-a1256ca7>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/servicos/gestao_de_conteudo.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Gest\xE3o de conte\xFAdo e redes sociais"
      }, null, _parent));
      _push(`<h3 data-v-a1256ca7>Redes sociais</h3></div></div><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-a1256ca7><div class="gscard gscard-border" data-v-a1256ca7>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/servicos/lojas_virtuais.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Lojas virtuais e marketing digital"
      }, null, _parent));
      _push(`<h3 data-v-a1256ca7>Lojas virtuais</h3></div></div><div class="col-6 col-sm-6 col-md-3" data-v-a1256ca7><div class="gscard gscard-border" data-v-a1256ca7>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/servicos/branding.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Cria\xE7\xE3o de marcas e branding"
      }, null, _parent));
      _push(`<h3 data-v-a1256ca7>Marcas</h3></div></div></div><div class="row mt-5" data-v-a1256ca7><div class="col" data-v-a1256ca7>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/servicos",
        class: "btn btn-primary"
      }, {
      ...
      _push(`<section class="text-center gscard my-5" id="cta" data-v-a1256ca7><div class="container d-flex align-items-center justify-content-center bg-cta my-5" data-v-a1256ca7><div class="row" data-v-a1256ca7><div class="col text-light" data-v-a1256ca7><h2 class="text-light" data-v-a1256ca7>Transforme Resultados com Design, Marketing e Tecnologia!</h2><div class="subheadline d-flex justify-content-center py-2" data-v-a1256ca7><p data-v-a1256ca7>Potencialize seu neg\xF3cio com solu\xE7\xF5es criativas e inovadoras. N\xF3s entregamos resultados excepcionais atrav\xE9s de estrat\xE9gias personalizadas e tecnologia de ponta.</p></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contato",
        class: "btn btn-white"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<em data-v-a1256ca7${_scopeId}>Entrar agora em contato</em>`);
          } else {
            return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a1256ca7"]]);

export { index as default };
//# sourceMappingURL=index-CKkmY3qC.mjs.map
