import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};export { s as closePrerenderer, q as localFetch } from './chunks/nitro/nitro.mjs';
