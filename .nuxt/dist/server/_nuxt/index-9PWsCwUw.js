import { _ as _export_sfc, N, a as __nuxt_component_0, b as useSeoMeta } from "../server.mjs";
import { _ as _sfc_main$4 } from "./NuxtImg-DCnneY7a.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      const _component_NuxtImg = _sfc_main$4;
      _push(`<!--[--><section class="d-flex align-items-center min-vh-100" id="index" data-v-92fe7fdc><div class="container text-center" data-v-92fe7fdc><div class="row" data-v-92fe7fdc><div class="col" data-v-92fe7fdc><h1 data-v-92fe7fdc><em data-v-92fe7fdc>Posicionamento, resultados e performance para sua empresa.</em></h1><p class="my-4" data-v-92fe7fdc>Fazemos sua empresa crescer usando branding, tecnologia e marketing.</p><div class="d-flex justify-content-center flex-wrap" data-v-92fe7fdc><button class="btn btn-primary my-2" data-v-92fe7fdc>Nos conheça um pouco</button>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contato",
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-92fe7fdc><div class="container" data-v-92fe7fdc><div class="row" data-v-92fe7fdc><div class="col-12 col-md-5" data-v-92fe7fdc><h2 data-v-92fe7fdc>Somos especialistas</h2><p class="my-3" data-v-92fe7fdc> A GS Studio é uma agência que combina marketing, design e tecnologia para criar soluções criativas que impulsionam o sucesso de negócios. Nosso foco está em entregar resultados que realmente fazem a diferença. </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/sobre",
        class: "btn btn-primary"
      }, {
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center justify-content-center bg-light py-5" id="servicos" data-v-92fe7fdc><div class="container text-center my-5" data-v-92fe7fdc><div class="row" data-v-92fe7fdc><h2 data-v-92fe7fdc>Soluções e serviços</h2><p class="my-3" data-v-92fe7fdc> A GS STUDIO está comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estratégia eficaz, geram resultados melhores e duradouros. </p><div class="row p-3" data-v-92fe7fdc><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-92fe7fdc><div class="gscard gscard-border" data-v-92fe7fdc>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
...
//# sourceMappingURL=index-9PWsCwUw.js.map
