...
import { u as useRequestEvent, a as useNuxtApp, b as useRuntimeConfig, _ as _export_sfc, N } from "../server.mjs";
import { computed, defineComponent, ref, h, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, useSSRContext } from "vue";
import { defu } from "defu";
import { hasProtocol, withLeadingSlash, joinURL, parseURL, encodePath, encodeParam } from "ufo";
import { appendHeader } from "h3";
import { Autoplay } from "swiper/modules";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr } from "vue/server-renderer";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${ssrRenderAttrs(_attrs)} data-v-9403af06><section class="d-flex align-items-center min-vh-100" id="index" data-v-9403af06><div class="container text-center" data-v-9403af06><div class="row" data-v-9403af06><div class="col" data-v-9403af06><h1 data-v-9403af06>Aumente a <em data-v-9403af06>performance</em> da sua <em data-v-9403af06>empresa.</em></h1><p class="my-4" data-v-9403af06>Destaque sua empresa à frente de seus concorrentes com estratégias de branding, marketing e tecnologia.</p><div class="d-flex justify-content-center" data-v-9403af06><button class="btn btn-primary" data-v-9403af06>Nos conheça um pouco</button><button class="btn btn-primary-border" data-v-9403af06>Entre em contato rapidamente</button></div></div></div></div></section><section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-9403af06><div class="container" data-v-9403af06><div class="row" data-v-9403af06><div class="col-5" data-v-9403af06><h2 data-v-9403af06>Somos especialistas</h2><p class="my-3 d-block" data-v-9403af06> Design publicitário, marketing online/offline e websites. Na GS STUDIO, combinamos criatividade e estratégias comprovadas para desenvolver campanhas de marketing eficazes e impactantes. Nossos especialistas em tecnologia oferecem soluções personalizadas para maximizar a eficiência do seu negócio. </p></div><div class="col-7 text-center align-content-center content-justify-center px-5" data-v-9403af06><div data-v-9403af06><div class="d-flex" data-v-9403af06><div class="col-4 gscard gscard-border" data-v-9403af06>`);
  ...
  _push(`<section class="min-vh-100 align-content-center justify-content-center bg-light" id="servicos" data-v-9403af06><div class="container text-center" data-v-9403af06><div class="row justify-content-center align-content-center" data-v-9403af06><h2 data-v-9403af06>Soluções e serviços</h2><p class="my-3" data-v-9403af06> A GS STUDIO está comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estratégia eficaz, geram resultados melhores e duradouros. </p><div class="row mt-3" data-v-9403af06><div class="col-12 col-sm-6 col-md-3" data-v-9403af06><div class="gscard gscard-border" data-v-9403af06>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
  ...
  _push(`<h3 data-v-9403af06>Lojas virtuais</h3><h3 data-v-9403af06>Marcas</h3><span data-v-9403af06><a href="#none" data-v-9403af06>Saiba mais</a></span></div></div></div><div class="row mt-5" data-v-9403af06><div class="col" data-v-9403af06><button class="btn btn-primary" data-v-9403af06> Veja mais serviços</button></div></div></div></div></section><section class="text-center gscard my-5" id="cta" data-v-9403af06><div class="container justify-content-center align-content-center bg-cta my-5" data-v-9403af06><div class="row" data-v-9403af06><div class="col text-light" data-v-9403af06><h2 class="text-light" data-v-9403af06>Transforme Resultados com Design, Marketing e Tecnologia!</h2><div class="subheadline d-flex justify-content-center py-2" data-v-9403af06><p data-v-9403af06>Potencialize seu negócio com soluções criativas e inovadoras. Nós entregamos resultados excepcionais através de estratégias personalizadas e tecnologia de ponta.</p></div><button class="btn btn-white" data-v-9403af06><em data-v-9403af06>Começar orçamento</em></button></div></div></div></section></main>`);
}
...
//# sourceMappingURL=index-w-_08CAa.js.map
