import { ref, mergeProps, useSSRContext, withCtx, createTextVNode, createVNode, defineComponent, unref, createBlock, openBlock, Fragment, renderList, computed, withAsyncContext, toDisplayString } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr } from "vue/server-renderer";
import "hookable";
import { _ as _export_sfc, a as __nuxt_component_0$2, N, u as useHead, d as useSeoMeta } from "../server.mjs";
import { _ as _sfc_main$7 } from "./NuxtImg-Be9QiiK0.js";
import { Swiper, SwiperSlide } from "swiper/vue";
import { Autoplay } from "swiper/modules";
import { u as useAsyncData } from "./asyncData-BYrznCe9.js";
import { d as defineOgImage } from "./defineOgImage-CqgGswDu.js";
import "ofetch";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<p class="my-4 lead">Design, tecnologia e marketing para negócios que querem crescer com inteligência.</p><div class="d-flex justify-content-center flex-column flex-md-row align-items-center px-2">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Saiba mais sobre nós `);
      } else {
        return [
          createTextVNode(" Saiba mais sobre nós ")
        ];
      }
    }),
    _: 1
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({
    ...
    id: "cta"
  }, _attrs))}><div class="container d-flex align-items-center justify-content-center bg-cta my-5"><div class="row"><div class="col text-light"><h2 class="text-light">Transforme o seu negócio</h2><div class="subheadline d-flex justify-content-center py-2"><p>Potencialize seu negócio com soluções criativas e inovadoras.</p></div>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/contato",
    class: "btn btn-white"
  }, {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-ec75f201><div class="container" data-v-ec75f201><div class="row" data-v-ec75f201><div class="col-12 col-md-12 col-lg-6" data-v-ec75f201><h2 data-v-ec75f201>Somos especialistas</h2><p class="my-3" data-v-ec75f201> A GS Studio é uma agência que combina marketing, design e tecnologia para criar soluções criativas que impulsionam o sucesso de negócios. Nosso foco está em entregar resultados que realmente fazem a diferença. </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/sobre",
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center justify-content-center bg-light py-5" id="servicos" data-v-ec75f201><div class="container text-center my-5" data-v-ec75f201><div class="row" data-v-ec75f201><h2 data-v-ec75f201>Soluções e serviços</h2><p class="my-3" data-v-ec75f201> A GS STUDIO está comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estratégia eficaz, geram resultados melhores e duradouros. </p><div class="row p-3" data-v-ec75f201><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-ec75f201><div class="gscard gscard-border h-100" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "icons/servicos/sites.svg",
        class: "p-2 my-1",
        alt: "GS STUDIO - Criação de sites e comunicação"
      }, null, _parent));
      _push(`<h3 data-v-ec75f201>Criação de sites</h3></div></div><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-ec75f201><div class="gscard gscard-border h-100" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`<h3 data-v-ec75f201>Produção de marcas</h3></div></div></div><div class="row mt-5" data-v-ec75f201><div class="col" data-v-ec75f201>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/servicos",
        class: "btn btn-primary"
      }, {
...
//# sourceMappingURL=index-9aFFs86i.js.map
