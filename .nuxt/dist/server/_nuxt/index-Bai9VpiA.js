import { _ as _export_sfc, N, a as __nuxt_component_0, u as useHead, e as useSeoMeta } from "../server.mjs";
import { _ as _sfc_main$4 } from "./NuxtImg-C0-byqDt.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      const _component_NuxtImg = _sfc_main$4;
      _push(`<!--[--><section class="d-flex align-items-center min-vh-100" id="index" data-v-a1256ca7><div class="container text-center" data-v-a1256ca7><div class="row" data-v-a1256ca7><div class="col" data-v-a1256ca7><h1 data-v-a1256ca7><em data-v-a1256ca7>Posicionamento, resultados e performance para sua empresa.</em></h1><p class="my-4" data-v-a1256ca7>Fazemos sua empresa crescer usando branding, tecnologia e marketing.</p><div class="d-flex justify-content-center flex-column flex-md-row align-items-center px-2" data-v-a1256ca7><button class="btn btn-primary my-2" data-v-a1256ca7>Nos conheça um pouco</button>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contato",
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-a1256ca7><div class="container" data-v-a1256ca7><div class="row" data-v-a1256ca7><div class="col-12 col-md-5" data-v-a1256ca7><h2 data-v-a1256ca7>Somos especialistas</h2><p class="my-3" data-v-a1256ca7> A GS Studio é uma agência que combina marketing, design e tecnologia para criar soluções criativas que impulsionam o sucesso de negócios. Nosso foco está em entregar resultados que realmente fazem a diferença. </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/sobre",
        class: "btn btn-primary"
      }, {
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center justify-content-center bg-light py-5" id="servicos" data-v-a1256ca7><div class="container text-center my-5" data-v-a1256ca7><div class="row" data-v-a1256ca7><h2 data-v-a1256ca7>Soluções e serviços</h2><p class="my-3" data-v-a1256ca7> A GS STUDIO está comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estratégia eficaz, geram resultados melhores e duradouros. </p><div class="row p-3" data-v-a1256ca7><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-a1256ca7><div class="gscard gscard-border" data-v-a1256ca7>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
...
//# sourceMappingURL=index-Bai9VpiA.js.map
