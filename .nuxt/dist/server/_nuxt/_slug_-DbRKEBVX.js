...
import { f as fetchDefaults, b as useRequestFetch, d as useSeoMeta, e as useRoute, g as useRouter, _ as _export_sfc } from "../server.mjs";
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<div class="content_blog" data-v-76252475><div class="mb-3 mx-0" data-v-76252475><span class="article-category" data-v-76252475>${ssrInterpolate(categoryTitle.value)}</span><span class="mx-3 publish_date" data-v-76252475>${formatDate(unref(article).created_at) ?? ""}</span></div><h1 data-v-76252475>${ssrInterpolate(unref(article).title)}</h1><div class="my-4" data-v-76252475>${unref(article).content ?? ""}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div></section><section data-v-76252475><div class="container" data-v-76252475><div class="row" data-v-76252475><div class="col-md-6 col-sm-12 align-content-center mb-5 sm-mb-5" data-v-76252475><h1 data-v-76252475>Fale agora conosco</h1><p data-v-76252475>Entre em contato conosco para tirar suas dúvidas ou solicitar um orçamento.</p></div><div class="col-md-6 col-sm-12" data-v-76252475>`);
...
//# sourceMappingURL=_slug_-DbRKEBVX.js.map
