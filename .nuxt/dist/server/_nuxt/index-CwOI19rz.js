...
import { defineComponent, ref, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, useSSRContext, computed, createTextVNode, toDisplayString } from "vue";
...
import "./entry-styles-1.mjs-dEDWw5h0.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "portfolio-section my-5 min-vh-100 text-center" }, _attrs))} data-v-25140152><div class="container-fluid my-5" data-v-25140152><div class="row" data-v-25140152><div class="col-12 text-center" data-v-25140152><h2 data-v-25140152>Portifolio</h2></div></div><div class="row justify-content-center m-5" data-v-25140152><!--[-->`);
      ssrRenderList(imageRows.value, (row, rowIndex) => {
        _push(`<div class="col-12 image-row" data-v-25140152><div class="row justify-content-center" data-v-25140152><!--[-->`);
        ssrRenderList(row, (image, index2) => {
          _push(`<div class="col-4 col-md-2 mb-4" data-v-25140152><img${ssrRenderAttr("src", image.src)} class="image-thumbnail img-fluid" data-v-25140152></div>`);
        });
        _push(`<!--]--></div></div>`);
      });
      _push(`<!--]--></div><div class="row justify-content-center" data-v-25140152><div class="col-auto" data-v-25140152><button${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} class="btn btn-primary" data-v-25140152>`);
      if (loading.value) {
        _push(`<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" data-v-25140152></span>`);
      } else {
        _push(`<span data-v-25140152>Ver mais</span>`);
      }
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-25140152"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${ssrRenderAttrs(_attrs)} data-v-a43378b0><section class="d-flex align-items-center min-vh-100" id="index" data-v-a43378b0><div class="container text-center" data-v-a43378b0><div class="row" data-v-a43378b0><div class="col" data-v-a43378b0><h1 data-v-a43378b0>Aumente a <em data-v-a43378b0>performance</em> da sua <em data-v-a43378b0>empresa.</em></h1><p class="my-4" data-v-a43378b0>Destaque sua empresa à frente de seus concorrentes com estratégias de branding, marketing e tecnologia.</p><div class="d-flex justify-content-center" data-v-a43378b0><button class="btn btn-primary" data-v-a43378b0>Nos conheça um pouco</button><button class="btn btn-primary-border" data-v-a43378b0>Entre em contato rapidamente</button></div></div></div></div></section><section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-a43378b0><div class="container" data-v-a43378b0><div class="row" data-v-a43378b0><div class="col-5" data-v-a43378b0><h2 data-v-a43378b0>Somos especialistas</h2><p class="my-3 d-block" data-v-a43378b0> Design publicitário, marketing online/offline e websites. Na GS STUDIO, combinamos criatividade e estratégias comprovadas para desenvolver campanhas de marketing eficazes e impactantes. Nossos especialistas em tecnologia oferecem soluções personalizadas para maximizar a eficiência do seu negócio. </p></div><div class="col-7 text-center align-content-center content-justify-center px-5" data-v-a43378b0><div data-v-a43378b0><div class="d-flex" data-v-a43378b0><div class="col-4 gscard gscard-border" data-v-a43378b0>`);
  ...
  _push(`<section class="min-vh-100 align-content-center justify-content-center bg-light" id="servicos" data-v-a43378b0><div class="container text-center" data-v-a43378b0><div class="row justify-content-center align-content-center" data-v-a43378b0><h2 data-v-a43378b0>Soluções e serviços</h2><p class="my-3" data-v-a43378b0> A GS STUDIO está comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estratégia eficaz, geram resultados melhores e duradouros. </p><div class="row mt-3" data-v-a43378b0><div class="col-12 col-sm-6 col-md-3" data-v-a43378b0><div class="gscard gscard-border" data-v-a43378b0>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
  ...
  _push(`<h3 data-v-a43378b0>Lojas virtuais</h3><h3 data-v-a43378b0>Marcas</h3><span data-v-a43378b0><a href="#none" data-v-a43378b0>Saiba mais</a></span></div></div></div><div class="row mt-5" data-v-a43378b0><div class="col" data-v-a43378b0><button class="btn btn-primary" data-v-a43378b0> Veja mais serviços</button></div></div></div></div></section><section class="text-center gscard my-5" id="cta" data-v-a43378b0><div class="container justify-content-center align-content-center bg-cta my-5" data-v-a43378b0><div class="row" data-v-a43378b0><div class="col text-light" data-v-a43378b0><h2 class="text-light" data-v-a43378b0>Transforme Resultados com Design, Marketing e Tecnologia!</h2><div class="subheadline d-flex justify-content-center py-2" data-v-a43378b0><p data-v-a43378b0>Potencialize seu negócio com soluções criativas e inovadoras. Nós entregamos resultados excepcionais através de estratégias personalizadas e tecnologia de ponta.</p></div><button class="btn btn-white" data-v-a43378b0><em data-v-a43378b0>Começar orçamento</em></button></div></div></div></section>`);
...
//# sourceMappingURL=index-CwOI19rz.js.map
