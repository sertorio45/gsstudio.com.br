import { defineComponent, withAsyncContext, computed, withCtx, unref, createTextVNode, toDisplayString, createVNode, useSSRContext } from "vue";
import { u as useHead, b as useRoute, d as useRouter, e as useRuntimeConfig, f as useServerSeoMeta, _ as _export_sfc } from "../server.mjs";
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<div class="content_blog" data-v-e8c1504e><div class="mb-3 mx-0" data-v-e8c1504e><span class="article-category" data-v-e8c1504e>${ssrInterpolate(categoryTitle.value)}</span><span class="mx-3 publish_date" data-v-e8c1504e>${formatDate(unref(article).created_at) ?? ""}</span></div><h1 data-v-e8c1504e>${ssrInterpolate(unref(article).title)}</h1><div class="my-4" data-v-e8c1504e>${unref(article).content ?? ""}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div></section><section data-v-e8c1504e><div class="container" data-v-e8c1504e><div class="row" data-v-e8c1504e><div class="col-md-6 col-sm-12 align-content-center mb-5 sm-mb-5" data-v-e8c1504e><h1 data-v-e8c1504e>Fale agora conosco</h1><p data-v-e8c1504e>Entre em contato conosco para tirar suas dúvidas ou solicitar um orçamento.</p></div><div class="col-md-6 col-sm-12" data-v-e8c1504e>`);
...
//# sourceMappingURL=_slug_-Cxwv2axZ.js.map
