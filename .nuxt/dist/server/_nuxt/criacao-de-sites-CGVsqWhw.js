...
import { defineComponent, mergeProps, useSSRContext, withCtx, createTextVNode } from "vue";
...
import { _ as __nuxt_component_2 } from "./Form-CzPHgJr2.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` / <span data-v-7821b13a>Criação de Sites</span></div><h1 class="fw-bold mb-3" data-v-7821b13a>Seu site profissional começa aqui</h1><p class="lead mb-4" data-v-7821b13a>Transforme sua presença digital com um site rápido, bonito e pronto para converter visitantes em clientes.</p><div class="d-flex gap-3 justify-content-center mb-4" data-v-7821b13a>`);
      _push(ssrRenderComponent(_component_ButtonPrimary, { class: "me-2" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Solicitar Orçamento`);
          } else {
            return [
              createTextVNode("Solicitar Orçamento")
            ];
          }
        }),
        _: 1
      ...
      _push(`<!--]--></tbody></table></div><p class="text-center text-light my-3 bg-danger p-3 rounded-3" data-v-7821b13a>Os prazos apresentados são estimativas médias para sites institucionais com conteúdo básico. Projetos mais complexos podem requerer um cronograma personalizado.</p></div></section><section id="differentials" class="container py-5" data-v-7821b13a><h2 class="text-center my-5 fw-bold" data-v-7821b13a>Nossos Diferenciais</h2><div class="row row-cols-2 row-cols-md-5 g-4 justify-content-center" data-v-7821b13a><!--[-->`);
      ...
      _push(`<!--]--></div></div></section><section id="cta-final" class="container py-5 d-flex flex-column align-items-center justify-content-center text-center" data-gsap="fade-in scale" data-v-7821b13a><h2 class="fw-bold mb-3" data-v-7821b13a>Pronto mudar o seu negócio?</h2><p class="lead mb-4" data-v-7821b13a>Solicite um orçamento sem compromisso ou veja nosso portfólio de cases de sucesso.</p><div class="d-flex gap-3 justify-content-center mb-4" data-v-7821b13a>`);
...
export {
  criacaoDeSites as default
};
//# sourceMappingURL=criacao-de-sites-CGVsqWhw.js.map
