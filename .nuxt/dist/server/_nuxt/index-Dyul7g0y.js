...
import { _ as _sfc_main$4 } from "./NuxtImg-D6UusSGj.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-ac5efce7><div class="container" data-v-ac5efce7><div class="row" data-v-ac5efce7><div class="col-12 col-md-5" data-v-ac5efce7><h2 data-v-ac5efce7>Somos especialistas</h2><p class="my-3" data-v-ac5efce7> A GS Studio é uma agência que combina marketing, design e tecnologia para criar soluções criativas que impulsionam o sucesso de negócios. Nosso foco está em entregar resultados que realmente fazem a diferença. </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/sobre",
        class: "btn btn-primary"
      }, {
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center justify-content-center bg-light py-5" id="servicos" data-v-ac5efce7><div class="container text-center my-5" data-v-ac5efce7><div class="row" data-v-ac5efce7><h2 data-v-ac5efce7>Soluções e serviços</h2><p class="my-3" data-v-ac5efce7> A GS STUDIO está comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estratégia eficaz, geram resultados melhores e duradouros. </p><div class="row p-3" data-v-ac5efce7><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-ac5efce7><div class="gscard gscard-border" data-v-ac5efce7>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
...
//# sourceMappingURL=index-Dyul7g0y.js.map
