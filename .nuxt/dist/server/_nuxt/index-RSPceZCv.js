...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><section class="d-flex align-items-center min-vh-100" id="index" data-v-b31ad5cc><div class="container text-center" data-v-b31ad5cc><div class="row" data-v-b31ad5cc><div class="col" data-v-b31ad5cc><h1 data-v-b31ad5cc><em data-v-b31ad5cc>Posicionamento, resultados e performance para sua empresa.</em></h1><p class="my-4" data-v-b31ad5cc>Fazemos sua empresa crescer usando branding, tecnologia e marketing.</p><div class="d-flex justify-content-center flex-column flex-md-row align-items-center px-2" data-v-b31ad5cc><a class="btn btn-primary my-2" data-v-b31ad5cc>Nos conheça um pouco</a>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contato",
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center bg-light py-5" id="sobre" data-v-b31ad5cc><div class="container" data-v-b31ad5cc><div class="row" data-v-b31ad5cc><div class="col-12 col-md-5" data-v-b31ad5cc><h2 data-v-b31ad5cc>Somos especialistas</h2><p class="my-3" data-v-b31ad5cc> A GS Studio é uma agência que combina marketing, design e tecnologia para criar soluções criativas que impulsionam o sucesso de negócios. Nosso foco está em entregar resultados que realmente fazem a diferença. </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/sobre",
        class: "btn btn-primary"
      }, {
      ...
      _push(`</div></div></div></div></section><section class="d-flex align-items-center justify-content-center bg-light py-5" id="servicos" data-v-b31ad5cc><div class="container text-center my-5" data-v-b31ad5cc><div class="row" data-v-b31ad5cc><h2 data-v-b31ad5cc>Soluções e serviços</h2><p class="my-3" data-v-b31ad5cc> A GS STUDIO está comprometida com resultados. Acreditamos que a criatividade e o design, alinhados com uma estratégia eficaz, geram resultados melhores e duradouros. </p><div class="row p-3" data-v-b31ad5cc><div class="col-6 col-sm-6 col-md-3 mb-3 mb-md-0" data-v-b31ad5cc><div class="gscard gscard-border" data-v-b31ad5cc>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
...
//# sourceMappingURL=index-RSPceZCv.js.map
