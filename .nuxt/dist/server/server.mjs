...
import { defineHeadPlugin, unpackMeta, composableNames } from "@unhead/shared";
...
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash, parseURL, withLeadingSlash, withBase, withoutBase } from "ufo";
...
const _routes = [
  {
    name: "slug",
    path: "/:slug()",
    component: () => import("./_nuxt/_slug_-DbRKEBVX.js")
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/blog-FC2Xg3KV.js")
  },
  {
    name: "cases-mdmoveis",
    path: "/cases/mdmoveis",
    component: () => import("./_nuxt/mdmoveis-Cem2ihnB.js")
  },
  {
    name: "contato",
    path: "/contato",
    component: () => import("./_nuxt/contato-D_1bcZij.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-9aFFs86i.js")
  },
  {
    name: "politica-de-privacidade",
    path: "/politica-de-privacidade",
    component: () => import("./_nuxt/politica-de-privacidade-OGpw6IyM.js")
  },
  {
    name: "servicos-criacao-de-sites",
    path: "/servicos/criacao-de-sites",
    component: () => import("./_nuxt/criacao-de-sites-CQ1vb7i5.js")
  },
  {
    name: "servicos",
    path: "/servicos",
    component: () => import("./_nuxt/index-D5gkgpst.js")
  },
  {
    name: "sobre",
    path: "/sobre",
    component: () => import("./_nuxt/sobre-Qyv7c27G.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-5t4rQza-.js"))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-e1Tq98mb.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DR4xEXGs.js"));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-DJ53Ok_A.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
