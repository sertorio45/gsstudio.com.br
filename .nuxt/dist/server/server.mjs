...
import { hasProtocol, isScriptProtocol, joinURL, withQuery, parseQuery, withTrailingSlash, withoutTrailingSlash, parseURL, withLeadingSlash, withBase, withoutBase } from "ufo";
...
import { SchemaOrgUnheadPlugin, useSchemaOrg as useSchemaOrg$1 } from "@unhead/schema-org";
...
const _routes = [
  {
    name: "slug",
    path: "/:slug()",
    component: () => import("./_nuxt/_slug_-AaHyF-2v.js")
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/blog-DOIRhTwd.js")
  },
  {
    name: "cases-mdmoveis",
    path: "/cases/mdmoveis",
    component: () => import("./_nuxt/mdmoveis-_nb-2XJS.js")
  },
  {
    name: "contato",
    path: "/contato",
    component: () => import("./_nuxt/contato-B2EJw7-s.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Ce9AjabY.js")
  },
  {
    name: "politica-de-privacidade",
    path: "/politica-de-privacidade",
    component: () => import("./_nuxt/politica-de-privacidade-T4BwB4w0.js")
  },
  {
    name: "servicos-criacao-de-sites",
    path: "/servicos/criacao-de-sites",
    component: () => import("./_nuxt/criacao-de-sites-CGVsqWhw.js")
  },
  {
    name: "servicos",
    path: "/servicos",
    component: () => import("./_nuxt/index-642VYhUl.js")
  },
  {
    name: "sobre",
    path: "/sobre",
    component: () => import("./_nuxt/sobre-BpAWYRkG.js")
  }
];
...
function getOgImagePath(pagePath, _options) {
  ...
  return joinURL("/", baseURL2, `__og-image__/${import.meta.prerender ? "static" : "image"}`, pagePath, `og.${options.extension}`);
}
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CKLp_IXd.js"))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B6OECApX.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-mSAioaM-.js"));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-C5IVTjWC.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export {
  ...
  useServerSeoMeta as h,
  injectHead as i,
  useSeoMeta as j,
  useOgImageRuntimeConfig as k,
  createOgImageMeta as l,
  getOgImagePath as m,
