...
const _routes = [
  {
    name: "artigos-slug",
    path: "/artigos/:slug()",
    component: () => import("./_nuxt/_slug_-D9ZRvEPl.js").then((m2) => m2.default || m2)
  },
  {
    name: "contato",
    path: "/contato",
    component: () => import("./_nuxt/contato-kVlLCzC-.js").then((m2) => m2.default || m2)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Df79NoP3.js").then((m2) => m2.default || m2)
  },
  {
    name: "servicos",
    path: "/servicos",
    component: () => import("./_nuxt/servicos-Cg29Xlvi.js").then((m2) => m2.default || m2)
  },
  {
    name: "solucoes",
    path: "/solucoes",
    component: () => import("./_nuxt/solucoes-BIhxjt7v.js").then((m2) => m2.default || m2)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-DzAKTHWd.js").then((m2) => m2.default || m2)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-khToBYL2.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DvPkWi5X.js").then((r) => r.default || r));
