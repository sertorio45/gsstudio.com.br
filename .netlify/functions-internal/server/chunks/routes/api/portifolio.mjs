...
const _assets = {
  ["nuxt-og-image:fonts:Inter-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2024-11-25T01:11:37.403Z"}
  },
  ["nuxt-og-image:fonts:Inter-700.ttf.base64"]: {
    import: () => import('../../raw/Inter-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2024-11-25T01:11:37.403Z"}
  }
};
...
const _q1s6iD = defineEventHandler$1(async (e) => {
...
const _Ylj0Ft = defineEventHandler$1(async (e) => {
...
const _RsAwYj = defineEventHandler$1(async (e) => {
...
const _Jr1oqW = defineEventHandler$1(async (e) => {
...
const _AJtCI4 = defineEventHandler$1(async (e) => {
...
const _F2QWG1 = defineEventHandler$1(async (e) => {
...
const _qm5EM7 = defineEventHandler$1(async (e) => {
...
const _lazy_rzruMJ = () => import('../renderer.mjs').then(function (n) { return n.r; });
