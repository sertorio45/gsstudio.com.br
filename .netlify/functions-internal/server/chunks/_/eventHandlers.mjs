import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { H as prefixStorage, I as useStorage, J as useNitroOrigin, K as emojiCache, L as useOgImageRuntimeConfig, c as createError, M as fetchIsland, N as normaliseFontInput, f as withTrailingSlash, O as getQuery, P as handleCacheHeaders, Q as setHeaders, R as setHeader, S as hash, q as parseURL, T as setResponseHeader, U as proxyRequest, V as sendRedirect, W as resolveContext, X as H3Error } from '../nitro/nitro.mjs';
