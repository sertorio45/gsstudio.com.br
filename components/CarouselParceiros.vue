  ...
  <div class="swiper-container my-5">
    ...
    >
      <SwiperSlide v-for="(parceiro, index) in parceiros1" :key="index">
        <img :src="parceiro" class="d-block w-100 parceiro-img" alt="Parceiros GS STUDIO"  loading="lazy" width="300px" height="300px"/>
      </SwiperSlide>
    </Swiper>
  ...
  <div class="swiper-container my-5">
    ...
    >
      <SwiperSlide v-for="(parceiro, index) in parceiros2" :key="index">
        <img :src="parceiro" class="d-block w-100 parceiro-img" :alt="'Parceiro ' + (index + 1)" loading="lazy" width="300px" height="300px"/>
      </SwiperSlide>
    </Swiper>
    <div class="swiper-gradient-left"></div>
    <div class="swiper-gradient-right"></div>
